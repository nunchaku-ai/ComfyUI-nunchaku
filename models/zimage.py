...
from comfy.ldm.lumina.model import NextDiT, JointTransformerBlock, JointAttention, FeedForward, clamp_fp16
...
def fuse_to_svdquant_linear(comfy_linear1: nn.Linear, comfy_linear2: nn.Linear, **kwargs) -> SVDQW4A4Linear:
    ...
    assert comfy_linear1.bias == None and comfy_linear2.bias == None
